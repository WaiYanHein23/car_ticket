...
$username=$email=$password=$ph_no=$address="";
$username_err=$email_err=$password_err=$ph_no_err=$address_err="";
$validate=true;
$success=false;
$invalid=false;
$emailExists='';
...
if($validate){
  ...
  $status=save_user($mysqli,$username,$email,$password_hash,$address,$ph_no);
  if($status){
    $success=true;
  }else{
    $invalid=true;
