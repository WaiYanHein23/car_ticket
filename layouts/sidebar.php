...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item active">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="../admin/add_car.php" class="menu-link">
            <div data-i18n="Without menu">Registration</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="../admin/car.php" class="menu-link">
            <div data-i18n="Without navbar">Car List</div>
          </a>
        </li>
    ...
    <li class="menu-item active">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="../admin/add_location.php" class="menu-link">
            <div data-i18n="Without menu"> Registration</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="../admin/location.php" class="menu-link">
            <div data-i18n="Without navbar">Location List</div>
          </a>
        </li>
    ...
    <li class="menu-item active">
      ...
      <i class="fa-solid fa-calendar-days me-2"></i>
        <div data-i18n="Layouts">Schedule List</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="../admin/add_schedule.php" class="menu-link">
            <div data-i18n="Without menu"> Registration</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="../admin/schedule.php" class="menu-link">
            <div data-i18n="Without navbar">Schedule List</div>
          </a>
        </li>
